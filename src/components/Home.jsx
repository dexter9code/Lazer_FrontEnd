...
const Home=()=>{
    ...
    return(
        <div>
            <div className='invisible md:visible  w-[2400px]  flex'>
                <div className='absolute p-5 flex justify-between'>
                    ...
                    <h1 className='text-6xl font-bold text-white capitalize'>India's <motion.span initial={{x:'-100vh',opacity:0}} animate={{x:0,opacity:1,scale:2}} transition={{duration:10,ease:'easeInOut',type:'spring',stiffness:130}} className='px-1 mr-2'>First</motion.span>and only DeBrand Store</h1>
                </div>
                    <span className='absolute top-44 left-24 italic text-white font-semibold text-xl'>Awesome Discount every Hour Shop Now</span>
                <svg xmlns="http://www.w3.org/2000/svg" className='-z-10' viewBox="0 0 1440 320"><motion.path variants={HomeSvgVariant} initial='hidden' animate='visible' fill="#0099ff" fill-opacity="1" d="M0,160L48,144C96,128,192,96,288,90.7C384,85,480,107,576,96C672,85,768,43,864,21.3C960,0,1056,0,1152,16C1248,32,1344,64,1392,80L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></motion.path></svg>
                <video src={homevideo} loop autoPlay muted className='-z-20 w-[1920px] h-[700px] object-cover absolute' />
            </div>
            ...
            <div className=' md:hidden'>
                <div className={show ? 'absolute top-[320px] mt-3':'absolute top-24'}>
                    <h1 className='text-3xl px-3 py-1 font-bold ml-10 '>India's First and only DeBrand Store</h1>
